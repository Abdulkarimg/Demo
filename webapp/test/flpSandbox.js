		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#twcomakgassignment01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"twcomakgassignment01-display": {
								"semanticObject": "twcomakgassignment01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tw.com.akgassignment01",
									"url": sap.ui.require.toUrl("tw/com/akgassignment01")
								}
							}
						}
					}
